...
# 2 "<built-in>" 2
# 1 "main_Proyecto_I2C_Servos.c" 2
...
# 8 "main_Proyecto_I2C_Servos.c" 2
...
# 9 "main_Proyecto_I2C_Servos.c" 2
...
# 10 "main_Proyecto_I2C_Servos.c" 2


#pragma config FOSC = INTOSC_EC
#pragma config WDT = OFF
#pragma config LVP = OFF
# 53 "main_Proyecto_I2C_Servos.c"
void settings(void);
...
void Servos(void);
void abre_griper(void);
void cierra_griper(void);
void sube_junta(void);
void baja_junta(void);
void gira_derecha(void);
void gira_izquierda(void);
...
void main(void) {
    settings();
    writeI2C(0xA0,0xB0,name,16);
    writeI2C(0xA0,0xFF,&name[5],1);
    readI2C(0xA0,0xB0,dataSaved,16);
    while(1){
        Servos();
...
void Servos(void){
    data2[0] = 0;
    data2[1] = 0;
# 114 "main_Proyecto_I2C_Servos.c"
    baja_junta();
    cierra_griper();
    sube_junta();
    gira_derecha();
...
void abre_griper(void){
    pos = map (0, 0 , 180 , 110, 510);
    data2[2] = pos;
    data2[3] = pos >> 8;
    writeI2C(0x80, 0x06 + (4 * 0), data2, 4);
    _delay((unsigned long)((1000)*(8000000/4000.0)));
}

void cierra_griper(void){
    pos = map (180, 0 , 180 , 110, 510);
    data2[2] = pos;
    data2[3] = pos >> 8;
    writeI2C(0x80, 0x06 + (4 * 0), data2, 4);
    _delay((unsigned long)((1000)*(8000000/4000.0)));
...
void sube_junta(void){
    ...
    data2[2] = pos;
    data2[3] = pos >> 8;
    writeI2C(0x80, 0x06 + (4 * 1), data2, 4);
    _delay((unsigned long)((1000)*(8000000/4000.0)));
}
...
void gira_izquierda(void){
    ...
    data2[2] = pos;
    data2[3] = pos >> 8;
    writeI2C(0x80, 0x06 + (4 * 2), data2, 4);
    _delay((unsigned long)((1000)*(8000000/4000.0)));
}

void gira_derecha(void){
    pos = map (90, 0 , 180 , 110, 510);
    data2[2] = pos;
    data2[3] = pos >> 8;
    writeI2C(0x80, 0x06 + (4 * 2), data2, 4);
    _delay((unsigned long)((1000)*(8000000/4000.0)));
...
void setPWMFreq(float freq){
    ...
    readI2C1(0x80, 0x00, data1, 1);

    unsigned char newmode = (data1 & ~0x80) | 0x10;
    writeI2C1(0x80, 0x00, newmode);
    writeI2C1(0x80, 0xFE, prescale);
    writeI2C1(0x80, 0x00, data1);
    _delay((unsigned long)((5)*(8000000/4000.0)));

    writeI2C1(0x80, 0x00, (data1 | 0x80 | 0x20));
}
