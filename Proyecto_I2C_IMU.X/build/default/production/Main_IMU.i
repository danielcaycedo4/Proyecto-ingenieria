...
accelx = (float)raw_accelx * 2.0/32768.0; accely = (float)raw_accely * 2.0/32768.0; accelz = (float)raw_accelz * 2.0/32768.0;
gyrox = (float)raw_gyrox * 250.0/32768.0; gyroy = (float)raw_gyroy * 250.0/32768.0; gyroz = (float)raw_gyroz * 250.0/32768.0;
temp = (float)(raw_temp/333.87) + 21;
...
start();
writeI2C1(0xD0, 0x6B,0x00);
_delay((unsigned long)((10)*(8000000/4000.0)));
sprintf(text,"INICIALIZANDO TEST WHO I AM \n");
start();
readI2C(0xD0,0x75,data,1);
if (data[0] != 0x68) {
...
writeI2C1(0xD0,0x1B,0x00);
writeI2C1(0xD0,0x1C,0x00);
_delay((unsigned long)((10)*(8000000/4000.0)));
}
