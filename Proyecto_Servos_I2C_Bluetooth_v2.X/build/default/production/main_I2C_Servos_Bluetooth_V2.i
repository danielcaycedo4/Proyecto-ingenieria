...
# 1 "main_I2C_Servos_Bluetooth_V2.c"
...
# 12 "main_I2C_Servos_Bluetooth_V2.c"
...
int i, pos, dato ,DriverPin = 0,servos=5;
...
sprintf(text," Servo: %d",servo);
start();
sprintf(text," Angulo: %d",angulo);
start();
_delay((unsigned long)((1000)*(8000000/4000.0)));
}
